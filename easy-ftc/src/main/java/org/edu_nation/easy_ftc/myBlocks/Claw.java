...
public class Claw extends BlocksOpModeCompanion {
    ...
    @ExportToBlocks(
            ...
            parameterLabels = {"Claw.Builder", "deviceNames"})
    public static org.edu_nation.easy_ftc.mechanism.Claw.Builder reverse(
            org.edu_nation.easy_ftc.mechanism.Claw.Builder builder, String[] deviceNames) {
    ...
    @ExportToBlocks(
            ...
            parameterLabels = {"Claw.Builder", "Names"})
    public static org.edu_nation.easy_ftc.mechanism.Claw.Builder names(
            org.edu_nation.easy_ftc.mechanism.Claw.Builder builder, String[] names) {

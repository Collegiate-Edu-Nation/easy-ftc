...
/**
 * Blueprints an abstract arm utility class, providing a method for scaling directions, which is common to all arms.
 * Cannot be instantiated, only extended by other classes providing static methods (see {@link DualArmUtil} and {@link SoloArmUtil}).
 * <p>
 * @Methods

...
/**
 * Provides static utility methods for moving a one-motor lift by extending the functionality of {@link LiftUtil}.
 * @Methods
 * {@link #controlToDirection(double deadZone, float lt, float rt)}
 * <li>{@link #languageToDirection(String direction)}
 * <li>{@link #map(double controllerValue, double deadZone)} (inherited from {@link LiftUtil})
 * <li>{@link #scaleDirections(double power, double [] motorDirections)} (inherited from {@link LiftUtil})
 */
class SoloLiftUtil extends LiftUtil {
    /**

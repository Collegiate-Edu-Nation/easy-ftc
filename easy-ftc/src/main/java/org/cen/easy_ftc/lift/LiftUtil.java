...
/**
 * Blueprints an abstract lift utility class, providing methods for mapping controls and scaling directions, which are common to all lifts.
 * Cannot be instantiated, only extended by other classes providing static methods (see {@link DualLiftUtil} and {@link SoloLiftUtil}).
 * <p>
 * @Methods

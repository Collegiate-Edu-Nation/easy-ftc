...
public class TestDrive {
        ...
        private void mockInit() {
                ...
                when(mockedHardwareMap.get(DcMotorEx.class, "driveRight"))
                                .thenReturn(mockedMotorEx);
                ...
                when(mockedHardwareMap.get(DcMotorEx.class, "frontRight"))
                                .thenReturn(mockedMotorEx);
        ...
        public void Drive_initializes() {
                ...
                try {
                        ...
                        new Drive.Builder(mockedOpMode, mockedHardwareMap).reverse("driveLeft")
                                        .build();
                        new Drive.Builder(mockedOpMode, mockedHardwareMap).reverse("driveRight")
                                        .build();
                        new Drive.Builder(mockedOpMode, mockedHardwareMap).reverse("driveLeft")
                                        .reverse("driveRight").build();
                        new Drive.Builder(mockedOpMode, mockedHardwareMap).encoder()
                                        .reverse("driveLeft").reverse("driveRight").build();
                        ...
                        new Drive.Builder(mockedOpMode, mockedHardwareMap).encoder().diameter(4)
                                        .gamepad(mockedGamepad).layout("arcade").build();
                        new Drive.Builder(mockedOpMode, mockedHardwareMap).encoder().diameter(4)
                                        .gearing(19.2).gamepad(mockedGamepad).layout("arcade")
                                        .build();
                        new Drive.Builder(mockedOpMode, mockedHardwareMap).encoder().diameter(4)
                        ...
                        new Drive.Builder(mockedOpMode, mockedHardwareMap).type("mecanum")
                                        .deadzone(0.1).build();
                        new Drive.Builder(mockedOpMode, mockedHardwareMap).encoder().type("mecanum")
                                        .build();
                        new Drive.Builder(mockedOpMode, mockedHardwareMap).reverse().type("mecanum")
                                        .build();
                        ...
                        new Drive.Builder(mockedOpMode, mockedHardwareMap).encoder()
                                        .reverse("backRight").reverse("frontLeft")
                                        .reverse("frontRight").reverse("backLeft").type("mecanum")
                                        .build();
                        new Drive.Builder(mockedOpMode, mockedHardwareMap).gamepad(mockedGamepad)
                                        .type("mecanum").build();
                        new Drive.Builder(mockedOpMode, mockedHardwareMap).type("mecanum")
                        ...
                        new Drive.Builder(mockedOpMode, mockedHardwareMap).encoder().diameter(4)
                                        .gamepad(mockedGamepad).type("mecanum").build();
                        new Drive.Builder(mockedOpMode, mockedHardwareMap).encoder()
                                        .gamepad(mockedGamepad).type("mecanum").layout("robot")
                                        .build();
                        new Drive.Builder(mockedOpMode, mockedHardwareMap).encoder().diameter(4)
                                        .gamepad(mockedGamepad).type("mecanum").layout("robot")
                                        .build();
                        new Drive.Builder(mockedOpMode, mockedHardwareMap).count(4).encoder()
                                        .diameter(4).gamepad(mockedGamepad).type("mecanum")
                                        .layout("robot").build();
                        new Drive.Builder(mockedOpMode, mockedHardwareMap).count(4).encoder()
                                        .diameter(4).gearing(19.2).gamepad(mockedGamepad)
                                        .type("mecanum").layout("robot").build();
                        new Drive.Builder(mockedOpMode, mockedHardwareMap).count(4).encoder()
                                        .diameter(4).reverse().gamepad(mockedGamepad)
                                        .type("mecanum").layout("robot").build();
                } catch (Exception e) {
                        fail(e.getMessage());
                }
        ...
        public void teleMec_isCalled() {
                ...
                try {
                        Drive drive = new Drive.Builder(mockedOpMode, mockedHardwareMap)
                                        .gamepad(mockedGamepad).type("mecanum").build();
                        Drive driveEnc = new Drive.Builder(mockedOpMode, mockedHardwareMap)
                                        .encoder().gamepad(mockedGamepad).type("mecanum").build();
        ...
        public void moveDif_isCalled() {
                ...
                try {
                        ...
                        Drive driveEnc = new Drive.Builder(mockedOpMode, mockedHardwareMap)
                                        .encoder().build();
                        Drive drivePos = new Drive.Builder(mockedOpMode, mockedHardwareMap)
        ...
        public void moveMec_isCalled() {
                ...
                try {
                        Drive drive = new Drive.Builder(mockedOpMode, mockedHardwareMap)
                                        .type("mecanum").build();
                        Drive driveEnc = new Drive.Builder(mockedOpMode, mockedHardwareMap)
                                        .encoder().type("mecanum").build();
                        Drive drivePos = new Drive.Builder(mockedOpMode, mockedHardwareMap)
                                        .encoder().diameter(4).type("mecanum").build();
        ...
        public void setGearingDif_ThrowsException() {
                ...
                Drive drive = new Drive.Builder(mockedOpMode, mockedHardwareMap).encoder()

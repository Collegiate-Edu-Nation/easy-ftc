...
public class TestMotorMechanism {
    ...
    public void whenOneMotor_scaleDirections_isCorrect() {
        ...
        // Test power zero
        for (int i = 0; i < 3; i++) {
            double[] movements = MotorMechanism.scaleDirections(motorDirections[i], powers[0]);
            for (int j = 0; j < 1; j++) {
        ...
        // Test power half
        for (int i = 0; i < 3; i++) {
            double[] movements = MotorMechanism.scaleDirections(motorDirections[i], powers[1]);
            for (int j = 0; j < 1; j++) {
        ...
        // Test power full
        for (int i = 0; i < 3; i++) {
            double[] movements = MotorMechanism.scaleDirections(motorDirections[i], powers[2]);
            for (int j = 0; j < 1; j++) {

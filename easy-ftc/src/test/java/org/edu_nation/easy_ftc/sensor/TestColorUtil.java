...
public class TestColorUtil {
    ...
    public void dominantColor_isCorrect() {
        int[][] rgbRawArrays = { { 76, 110, 85 }, { 75, 111, 85 }, { 75, 110, 86 }, { 75, 110, 85 }, { 76, 111, 86 } };
        int[] rgbOffsets = { 10, -25, 0 };
        double calibrationValue = 85.0;

        String[] colorsExpected = { "red", "green", "blue", "", "" };
        String[] colorsActual = { ColorUtil.dominantColor(rgbRawArrays[0], rgbOffsets, calibrationValue),

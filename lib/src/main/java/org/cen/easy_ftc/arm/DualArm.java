...
public class DualArm extends Arm {
     ...
     * <li>gamepad = null
     */
    public DualArm(LinearOpMode opMode, HardwareMap hardwareMap) {super(opMode, hardwareMap);}
    /**
     * Constructor
     * @Defaults 
     * gamepad = null
     */
    public DualArm(LinearOpMode opMode, HardwareMap hardwareMap, boolean useEncoder) {super(opMode, hardwareMap, useEncoder);}
    /**
     * Constructor
     * @Defaults
     * useEncoder = false
     */
    public DualArm(LinearOpMode opMode, HardwareMap hardwareMap, Gamepad gamepad) {super(opMode, hardwareMap, gamepad);}
    /**
     * Constructor
     */
    public DualArm(LinearOpMode opMode, HardwareMap hardwareMap, boolean useEncoder, Gamepad gamepad) {super(opMode, hardwareMap, useEncoder, gamepad);}
    ...
    protected void hardwareInit() {
        if(useEncoder) {
            ...
            // Sets velocityMultiplier to minimum ticks/rev of all arm motors (reduces the impact of mixing motor types)
            MotorConfigurationType [] motorType = {
                left_armEx.getMotorType(), 
